...
from REST_API_ROLF.models import StoreModel
...
class StoreList(MethodView):
    @blp.response(201, StoreSchema(many=True))  
    def get(self):
        return StoreModel.query.all()         #it will return list of values directly.
    ...
    def post(self, store_data): #schema will validate payload and pass to this function.
        ...
        try:
            ...
            abort(500, messga="An error occured while creating store.")
